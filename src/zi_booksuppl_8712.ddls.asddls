...
define view entity ZI_BOOKSUPPL_8712 as 
    ...
    association to parent ZI_BOOKING_8712 as _Booking
        on $projection.ParentUuid = _Booking.BookingUuid
          and $projection.RootUuid = _Booking.ParentUuid
    association [1..1] to ZI_TRAVEL_8712 as _Travel
                        on $projection.RootUuid = _Travel.TravelUuid
